 ...
 * Returns a unit's group callsign from its leader's Eden role description after `@`, falling back
 * to the group ID. Singleplayer returns an empty string.
 ...
 * Return Value: STRING - uppercase callsign or group ID; empty in singleplayer.
