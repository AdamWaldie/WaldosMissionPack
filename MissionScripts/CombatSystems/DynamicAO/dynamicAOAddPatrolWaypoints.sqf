 ...
 * first generated waypoint is made current explicitly. Aircraft receive their requested flight
...
diag_log format [
    "[WMP DYNAMIC AO] Route armed group=%1 local=%2 waypoints=%3 current=%4 units=%5.",
