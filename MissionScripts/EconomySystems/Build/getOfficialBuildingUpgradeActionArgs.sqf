 ...
 * EcoBuild system - getOfficialBuildingUpgradeActionArgs
 *
 * Part of the Waldos Economy Systems suite (Resource / Research / Build / Buy
 * + Ground Command). Registered as Waldo_fnc_EcoBuild_getOfficialBuildingUpgradeActionArgs via WaldosFunctions.sqf.
 *
 * Return Value:
