 ...
 * EcoBuild system - getOfficialBuildingInspectActionArgs
 *
 * Part of the Waldos Economy Systems suite (Resource / Research / Build / Buy
 * + Ground Command). Registered as Waldo_fnc_EcoBuild_getOfficialBuildingInspectActionArgs via WaldosFunctions.sqf.
 *
 * Return Value:
