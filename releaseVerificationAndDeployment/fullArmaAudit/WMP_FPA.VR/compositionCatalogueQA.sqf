...
private _vehicleClasses = [
    ...
    "B_crew_F", "B_Helipilot_F", "B_Heli_Light_01_F", "B_Mortar_01_F", "B_MRAP_01_F", "B_MRAP_01_hmg_F", "B_Pilot_F", "B_Soldier_F", "B_Soldier_SL_F", "B_Soldier_TL_F", "B_supplyCrate_F",
