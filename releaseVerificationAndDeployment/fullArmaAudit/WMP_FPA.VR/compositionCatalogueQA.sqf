...
private _vehicleClasses = [
    ...
    "B_crew_F", "B_Helipilot_F", "B_Heli_Light_01_F", "B_LSV_01_unarmed_F", "B_Mortar_01_F", "B_MRAP_01_F", "B_MRAP_01_gmg_F", "B_MRAP_01_hmg_F", "B_Pilot_F", "B_Soldier_F", "B_Soldier_SL_F", "B_Soldier_TL_F", "B_supplyCrate_F",
    "B_T_VTOL_01_armed_F", "B_T_VTOL_01_infantry_F", "B_Truck_01_covered_F", "B_Truck_01_medical_F",
    "B_Truck_01_transport_F", "Box_NATO_Ammo_F", "Box_NATO_Equip_F", "C_Van_01_transport_F", "Flag_Blue_F",
    ...
    "Land_HelipadEmpty_F", "Land_InfoStand_V1_F", "Land_InfoStand_V2_F", "Land_JumpTarget_F", "HeadlessClient_F",
...
private _declaredAddons = [
    ...
    "A3_Soft_F_MRAP_01", "A3_Soft_F_Exp_LSV_01", "A3_Static_F", "A3_Static_F_HMG_02", "A3_Static_F_Mortar_01",
