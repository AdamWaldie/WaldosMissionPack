 ...
 * Arguments: 0: group <GROUP>, grpNull; 1: expected revision <NUMBER>, -1; 2: reason <STRING>, ARRIVED.
 ...
 */
params [["_group", grpNull, [grpNull]], ["_expected", -1, [0]], ["_reason", "ARRIVED", [""]]];
...
private _accepted = [_group, 0] call Waldo_fnc_SimpleAiConvoy;
