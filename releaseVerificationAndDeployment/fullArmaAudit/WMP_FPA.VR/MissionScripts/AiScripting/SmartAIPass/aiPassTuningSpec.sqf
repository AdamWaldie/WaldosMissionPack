...
[
    ...
    ["Waldo_AIPass_Artillery_WarningInterval", "Ranging warning interval (s)", "Minimum pause after estimated impact before the next observed correction.", "SLIDER", [10, 60, 0], 20],
    // Counter-battery
