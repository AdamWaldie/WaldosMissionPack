 ...
 */
    ...
    _dimmer ctrlSetBackgroundColor [0, 0, 0, 0.44];
    ...
    _card ctrlSetBackgroundColor [0.015, 0.02, 0.025, 0.96];
    _card ctrlCommit 0;
    ...
    _header ctrlSetBackgroundColor [0.025, 0.20, 0.36, 0.99];
    _header ctrlSetTextColor [0.90, 0.96, 1, 1];
