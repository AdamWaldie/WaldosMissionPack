 ...
 */
    ...
    diag_log format ["[WMP ECO] Resource zone created id=%1 name=%2 position=%3 radius=%4 owner=%5 rows=%6 interval=%7", _zoneId, _safeName, _pos, _safeRadius, _safeOwner, _safeRows, _safeInterval];
    _zoneId
