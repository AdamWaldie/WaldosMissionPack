 ...
 * Adds the SITREP (situation report) radio-report format reference to the player's map diary.
 *
 * Arguments:
 * None
 *
 ...
 * Result: The player's Radio Reports diary subject gains the SITREP format.
 */
