...
if (_entity isKindOf "Man") then {
    ...
    if (_entity == player && {hasInterface}) then {
        ...
        // Physical effects always apply. Player-facing announcement is optional
        // and defaults off so mission makers control operational disclosure.
        if (missionNamespace getVariable ["Waldo_EMP_NotifyAffectedPlayers", false]) then {
