...
private _geometry = [_centre, _direction, _altitude, _approach, _runLength, _exitDistance, _circuitDirection] call Waldo_fnc_ParadropRouteGeometry;
private _standby = _geometry get "standby";
private _green = _geometry get "green";
_centre = _geometry get "centre";
private _red = _geometry get "red";
private _spawn = _geometry get "spawn";
private _exit = _geometry get "exit";
private _crosswind = _geometry get "crosswind";
private _downwind = _geometry get "downwind";
private _rejoin = _geometry get "rejoin";
private _hold = _geometry get "hold";
