...
[
    ...
    ],
    {
        ...
        if (isNull _tgt) exitWith {
            ["TRACKER NOT PLANTED", "No unit or vehicle is within 60 metres of the module.", 8, "FAILURE"] call Waldo_fnc_JammingNotice;
        };

        [_tgt, _sideStr, _label, _active] call Waldo_fnc_Tracker;
