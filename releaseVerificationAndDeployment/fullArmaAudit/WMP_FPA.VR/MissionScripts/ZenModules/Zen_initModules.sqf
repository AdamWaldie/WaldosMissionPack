...

{
    ...
    ["WMP Logistics", "Transport Service - Register", "TRANSPORT_REGISTER", "\A3\ui_f\data\map\vehicleicons\iconCar_ca.paa"],
    ["WMP Logistics", "Transport Service - Return to Base", "TRANSPORT_RTB", "\A3\ui_f\data\igui\cfg\simpletasks\types\meet_ca.paa"],
