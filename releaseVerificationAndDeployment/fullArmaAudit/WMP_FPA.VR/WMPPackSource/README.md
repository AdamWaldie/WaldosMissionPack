...
# Release Validation
The canonical feature test is the hosted **WMP PR REVIEW AUDIT** VR mission. Its builder stages
...
and ACRE2, disables BattlEye, uses 2560×1440, and keeps mutating automation off by default. The
