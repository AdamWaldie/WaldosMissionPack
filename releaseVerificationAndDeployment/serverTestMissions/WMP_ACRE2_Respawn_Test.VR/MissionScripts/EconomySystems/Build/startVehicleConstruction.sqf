 ...
 */
        ...
        private _sourceName = getText (configOf _vehicle >> "displayName");
        [_caller, format ["%1 deployed. %2 was converted into the construction site and consumed as designed.", _buildName, _sourceName]] call Waldo_fnc_EcoCore_notifyActor;
