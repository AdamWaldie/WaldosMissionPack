...
STATIONS = [
    ...
    ("headless", "HEADLESS CLIENT SUPPORT", (34, 92), "Native detection, registration, rebalance, migration funnel, disconnect recovery and diagnostics."),
    ...
    ("accessibility", "WMP HUD", (150, 40), "Equipment and UID accessibility eligibility, friendly identification, LOS and toggle behavior."),
    ...
    ("transport-services", "TRANSPORT SERVICES", (275, 40), "Independent helicopter and ground transport pools, named management, pickup, destination, disembark and physical RTB."),
    ...
    ("ui-theme-qa", "UI THEME QA", (325, 0), "Live switching across all twelve built-in WMP visual themes."),
...
def station_for(path: str) -> str:
    ...
    rules = [
        ...
        ("logistics/transportservices", "transport-services"),
        ...
        ("corpsetrap", "corpse-traps"), ("headless/", "headless"), ("thirdpartyscripts", "third-party"),
