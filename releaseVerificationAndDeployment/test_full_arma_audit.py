...
class FullAuditTests(unittest.TestCase):
    ...
    def test_pack_init_cannot_deadlock_on_dedicated_server(self):
        ...
        self.assertIn("private _deadline = diag_tickTime + 30;", acre_init)
        self.assertIn("Waldo_ACRE2_PlanReady", acre_init)
    ...
    def test_acre2_active_lifecycle_is_safe_and_legacy_is_manual(self):
        ...
        self.assertIn('["version", 2]', acre_config)
        ...
        self.assertIn("retuneOnGroupChange", acre_init)
        ...
        self.assertIn("['en', 'English'], ['fr', 'French'], ['ru', 'Russian']", audit_acre)
        ...
        self.assertIn('_prc343PresetPolicy == "FULL_RANGE"', validate_config)
        self.assertIn('getOrDefault ["prc343PresetPolicy", "FULL_RANGE"]', apply_plan)
        self.assertIn('exceeds preset %4 capacity', apply_plan)
