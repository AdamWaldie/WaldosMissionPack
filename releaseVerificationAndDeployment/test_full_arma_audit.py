...
class FullAuditTests(unittest.TestCase):
    ...
    def test_transport_services_have_repeat_safe_blue_identification_and_clear_usage(self):
        ...
        self.assertIn('Waldo_TransportService_LocalHoldToken', stop)
        ...
        self.assertIn("private _awayHelicopterHold", stop)
        self.assertNotIn('doStop driver _vehicle;', stop)
        ...
        self.assertIn('then {"TR UNLOAD"} else {"MOVE"}', dispatch)
        ...
        self.assertIn("private _clearanceRadius", request)
        ...
        self.assertIn('setWaypointType (if (_helicopter) then {"TR UNLOAD"}', dispatch)
