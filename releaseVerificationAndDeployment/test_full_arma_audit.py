...
class FullAuditTests(unittest.TestCase):
    ...
    def test_transport_services_have_repeat_safe_blue_identification_and_clear_usage(self):
        ...
        self.assertIn('_waypoint setWaypointType "SCRIPTED"', dispatch)
        ...
        self.assertIn('_group addWaypoint [_departurePosition, -1]', dispatch)
        self.assertIn('_departureWaypoint setWaypointType "MOVE"', dispatch)
        self.assertIn('_group addWaypoint [_target, -1]', dispatch)
        self.assertIn('currentWaypoint _group == _landingWaypointIndex', dispatch)
