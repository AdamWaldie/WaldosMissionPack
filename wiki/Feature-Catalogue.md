...
| [Helicopter Transport and Ground Taxi](Transport-Services) | Reusable server-reserved AI transport pools with physical pickup, destination, disembark and RTB lifecycles | Register AI-crewed vehicles by script or the focused WMP Logistics ZEN modules |
