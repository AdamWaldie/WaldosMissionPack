...
| [Smart AI Pass](Smart-AI-Pass) | Optional server and headless-client behaviour pass for non-player AI with per-behaviour switches; survivor regroup first | `MissionConfig\aiConfig.sqf`; disabled by default; **AI Control** in ZEN |
