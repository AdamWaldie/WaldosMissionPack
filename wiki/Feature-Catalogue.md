...
| [AI Rebalance](Waldos-AI-Tweak) | Named skill profiles, filters, variance, restoration and AI-locality migration handling | `MissionConfig\aiConfig.sqf`; **AI Control** in ZEN |
...
| [Smart AI Pass](Smart-AI-Pass) | Optional server and headless-client behaviour pass for non-player AI: contact state ladder, flanking with street crossing, fire control, morale, anti-armour, vehicles, reinforcement, artillery, airborne, garrison/clear orders and survivor regroup, each with its own switch | `MissionConfig\aiConfig.sqf`; disabled by default; **AI Control** and **AI Orders** in ZEN |
