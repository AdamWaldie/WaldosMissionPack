...
| [Dynamic Paradrop Operations](Vehicle-Actions-&-Paradrop#dynamic-drop-zone-operations) | Named server-owned drop routes with timed jumpers, flight limits, operational markers and teardown | Shared airframe/chute pools in `init.sqf`; scripted creation or create/remove ZEN modules |
