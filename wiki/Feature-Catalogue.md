...
| [Obituary and Confirmed-Death Reporting](Optional-Feature-Systems#obituary-and-confirmed-death-reporting) | Medic-only "Pronounce Dead" ACE self-interaction listing nearby corpses individually, with a formatted KIA report; feeds the AAR's "Confirmed deaths" section. Enabled by default | `MissionConfig\interfaceConfig.sqf`; runs automatically from `initPlayerLocal.sqf`; intentionally no ZEN module |
