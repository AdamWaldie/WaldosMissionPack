...
| [Emergency Dismount](Optional-Feature-Systems#emergency-dismount) | Local extraction from overturned or destroyed vehicles with configurable safety rules | Player settings in `initPlayerLocal.sqf` and scripted start/stop calls; intentionally no ZEN module |
...
| [Improved AI Helicopter Landings](Improved-AI-Helicopter-Landings) | Exact-point vector approaches, flare, slope alignment, tree-canopy clearance and bounded go-arounds for AI pilots | Shared settings in `init.sqf`; event-driven locality handlers; **AI - Helicopter Landing Control** in ZEN |
