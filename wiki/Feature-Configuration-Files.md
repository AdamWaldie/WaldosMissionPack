...
| `Waldo_Respawn_SeedOnSideSwitch` | Off by default. `true` = seed a respawn snapshot the first time a live side change (Zeus/admin reassignment) lands a player on a side with none saved yet. |
