...
- Autogenerated starer crates based on player starting loadouts & user definitions:
  - Can choose to add ace limited arsenal to starter crates (limited by player starting loadouts)
