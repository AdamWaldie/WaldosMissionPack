...
- Obituary / confirmed-death reporting - enabled by default. A medic's "Pronounce Dead" ACE interaction on a corpse replaces Arma's terse death message with a formatted KIA report (time, cause, grid, friendly-fire callout) and feeds a "Confirmed deaths" section into the After-Action Report.
