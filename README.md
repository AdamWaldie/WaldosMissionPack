...
- Vehicle Weapon Loadout - custom turret weapon/ammo add, replace, remove and clear, plus aircraft pylon set/clear, on any vehicle, script-callable or via a Zeus module placed directly on the target vehicle with its turret/pylon choices discovered live from that vehicle.
