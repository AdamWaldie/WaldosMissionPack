...
- Waldos Mini Games - seated multiplayer party games (Battleship, Who's Who, Shotgun Roulette, Blackjack, Poker, Chess, Checkers, RPS, UNO) plus nine diegetic field-equipment procedures. Players inspect distinct EOD controllers, diagnostic tablets, access terminals, lock cylinders, breaker cabinets, maintenance hatches, radios, hydraulic manifolds, and secure consoles. Procedures support colourblind-safe redundant cues, integrated operating instructions, immersive mission-specific profiles, original low-opacity equipment material textures, one-line Eden setup, authoritative callbacks, and an optional party-table equipment picker. (Table engine ported from "Party Games Scripted" by |LorÐ|™[Habilidade]Ðeus Ex.)
